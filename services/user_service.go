...
func (s *userService) FindAllPaginated(filter, sort string, limit, offset int)([]models.User, int64, error){
	return s.repo.FindAllPaginated(filter, sort, limit, offset)
}
